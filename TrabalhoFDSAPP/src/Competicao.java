...
public class Competicao {
    ...
    // =======================================================
       ...
       private String equipasParticipantes;
	...
	public String getEquipasParticipantes() {
		return equipasParticipantes;
	}
	public void setEquipasParticipantes(String equipasParticipantes) {
	...
	public String toString() {
		return "Competicoes [codigo=" + codigo + ", nome=" + nome + ", dataInicio=" + dataInicio + ", dataFim="
				+ dataFim + ", equipasParticipantes=" + equipasParticipantes + ", jogos=" + jogos + "]";
	}
